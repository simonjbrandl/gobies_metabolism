---
title: Metabolic rates mirror morphological and behavioral differences in two sand-dwelling coral reef gobies
...
This repository contains the code and data to reproduce all tables and figures presented in Brandl et al. "Metabolic rates mirror morphological and behavioral differences in two sand-dwelling coral reef gobies" 
...
- Text S1: Details pertaining to the sequencing protocol and bioinformatic pipeline used to compile sequence data used in the paper.

- Text S2: Short description of analytical methods and model summary outputs as obtained from the drake project, but in a separate word document.
